...
public class MusicPlayConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyMusicLists.Sources.Services.MusicPlay.MusicPlayConnection, MyMusicLists", MusicPlayConnection.class, __md_methods);
	}


	public MusicPlayConnection ()
	{
		super ();
		if (getClass () == MusicPlayConnection.class)
			mono.android.TypeManager.Activate ("MyMusicLists.Sources.Services.MusicPlay.MusicPlayConnection, MyMusicLists", "", this, new java.lang.Object[] {  });
	}
